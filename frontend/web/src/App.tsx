...
const App: React.FC = () => {
  ...
  // Load trade records from blockchain
          ...
          if (recordBytes.length > 0) {
            try {
              ...
              list.push({
                ...
                tradeType: recordData.tradeType,
                status: recordData.status || "pending",
                fheProof: recordData.fheProof || ""
              });
            } catch (e) {
  ...
  const submitRecord = async () => {
    ...
    setTransactionStatus({
      visible: true,
      status: "pending",
      message: "Encrypting trade data with FHE..."
    });
    
    try {
      // Simulate FHE encryption
      const encryptedData = `FHE-${btoa(JSON.stringify(newRecordData))}`;
      const fheProof = `FHE-PROOF-${Math.random().toString(36).substring(2, 12)}`;
      ...
      const recordData = {
        ...
        owner: account,
        tradeType: newRecordData.tradeType,
        status: "pending",
        fheProof: fheProof
      };
      ...
      setTransactionStatus({
        visible: true,
        status: "success",
        message: "Encrypted trade data submitted securely!"
      });
  ...
  // Check if current user is owner of record
  const isOwner = (address: string) => {
    return account.toLowerCase() === address.toLowerCase();
  };

  // Tutorial steps for FHE trade finance
  const tutorialSteps = [
    {
      title: "Connect Wallet",
      description: "Connect your Web3 wallet to access the trade finance platform",
      icon: "🔗"
    },
    {
      title: "Submit Encrypted Documents",
      description: "Upload encrypted trade documents (invoices, bills of lading) using FHE",
      icon: "📄"
    },
    {
      title: "FHE Cross-Verification",
      description: "System performs encrypted verification without exposing sensitive data",
      icon: "🔍"
    },
    {
      title: "Receive Credit Proof",
      description: "Get encrypted credit verification proof for financing institutions",
      icon: "🔒"
    }
  ];
      ...
      <div className="pie-chart-container">
        <div className="pie-chart">
          ...
          <div className="pie-center">
            ...
            <div className="pie-label">Trades</div>
          </div>
        </div>
    ...
    <div className="app-container metal-theme">
      <header className="app-header">
        <div className="logo">
          ...
          <h1>FHE<span>Trade</span>Verify</h1>
        </div>
      ...
      <div className="main-content">
        <div className="welcome-banner">
          <div className="welcome-text">
            <h2>FHE-Powered Trade Finance</h2>
            <p>Verify trade authenticity without exposing sensitive commercial data</p>
          </div>
        ...
        {showTutorial && (
          <div className="tutorial-section">
            <h2>Trade Verification with FHE</h2>
            <p className="subtitle">Securely validate trade documents while preserving confidentiality</p>
        ...
        <div className="dashboard-grid">
          <div className="dashboard-card metal-card">
            ...
            <p>FHE-TradeVerify enables financial institutions to validate trade documents using Fully Homomorphic Encryption without accessing sensitive commercial details.</p>
        ...
        <div className="records-section">
          ...
          <div className="records-list metal-card">
            <div className="table-header">
              ...
              <div className="header-cell">Trade Type</div>
              ...
              records.map(record => (
                <React.Fragment key={record.id}>
                  <div className="record-row" onClick={() => toggleRecordDetails(record.id)}>
                    ...
                    <div className="table-cell">{record.tradeType}</div>
      ...
      <footer className="app-footer">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="logo">
              <div className="shield-icon"></div>
              <span>FHE-TradeVerify</span>
            </div>
            <p>Secure trade finance verification using FHE technology</p>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="copyright">
            © {new Date().getFullYear()} FHE-TradeVerify. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
...
const ModalCreate: React.FC<ModalCreateProps> = ({ 
  ...
  const handleSubmit = () => {
    if (!recordData.tradeType || !recordData.sensitiveInfo) {
      ...
      <div className="create-modal metal-card">
        ...
        <div className="modal-body">
          <div className="fhe-notice-banner">
            <div className="key-icon"></div> Your trade data will be encrypted with FHE
          </div>
          ...
          <div className="form-grid">
            ...
            <div className="form-group full-width">
              ...
              <textarea 
                ...
                onChange={handleChange}
                placeholder="Enter sensitive trade details to encrypt..." 
